#Для того чтобы этот скрипт сработал, название файлов фотографий должно совпадать с атрибутом Samaccountname пользователей, все файлы должны быть в одном формате
